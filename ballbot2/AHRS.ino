...
void ahrs_set() {
  ...
  Serial.print(F("LSM9DS0 WHO_AM_I's returned: 0x"));
  Serial.println(status, HEX);
  Serial.println(F("Should be 0x49D4"));
  Serial.println();
...
void ahrs() {
  ...
  //if (displayOn[gyro] == 1){//delt_t > 1000) { // update LCD once per half-second independent of read rate
